...
public class HitboxCollision : MonoBehaviour
{
    ...
    public SuperBarController superBarController;
    ...
    void Start()
    {
        ...
        // Initializes facing to 0 (Might not be necessary)
        facingX = 0;
        facingY = 0;
    }
    ...
    private void OnTriggerEnter2D(Collider2D other)
    {
        ...
        {
            // Updates the variables with the value representing where the player is facing
            ...
            if (superBarController != null)
            {
                Debug.Log("Charging super bar");
                superBarController.ChargeSuperBar(1.0f);
            }
            else
            {
                Debug.LogError("SuperBarController reference is null!");
            }
        }
    }
}
